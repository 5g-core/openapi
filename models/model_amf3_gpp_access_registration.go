...
type Amf3GppAccessRegistration struct {
	...
	InitialRegistrationInd *bool `json:"initialRegistrationInd,omitempty" yaml:"initialRegistrationInd" bson:"initialRegistrationInd" mapstructure:"InitialRegistrationInd"`
